...
IMAGE im3 = { 250, 20, 0, +10 };
IMAGE im4 = { 250, 380, 0, -10 };
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        if (type == 0) Image0(hdc, image1_x, image1_y, RGB(255, 204, 255));
        if (type == 1) Image1(hdc, image1_x, image1_y, RGB(255, 204, 255));
        if (type == 2) Image2(hdc, image1_x, image1_y, RGB(255, 204, 255));
        if (type == 3) Image3(hdc, image1_x, image1_y, RGB(255, 204, 255));
        if (type == 4) Image4(hdc, image1_x, image1_y, RGB(255, 204, 255));
        EndPaint(hWnd, &ps);
    }
    break;
    case WM_DESTROY:
